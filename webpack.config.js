...
module.exports = {
  ...
  entry: {
    bundle: [
      ...
      './src/scripts/patch_download.js',
      './src/lib/cross-document-references-macro.js',
  ...
  plugins: [
    ...
    new CopyWebpackPlugin({
      patterns: [
        ...
        { from: 'node_modules/@asciidoctor/core/dist/browser/asciidoctor.js', to: 'asciidoctor.js' }
      ]
    })
  ]
}
